...
def check_one_user_simple():
    ...
    try:
        ...
        #return jsonify({"query":query,"Userid":Userid})
        handle_db_operation(query, fetch_all=True)
        return u.send_response()
    except Error as e:
        u.generic_error(e)
...
def update_user():
    ...
    salt = data.get('Salt')
    #return jsonify({"firstname":firstname,"lastname":lastname,"email":email,"password":password,"currency_amount":currency_amount,"tmp_email":tmp_email,"salt":salt})
